(() => {
  ...
  const uiTranslations = {
    en: {
      brandName: 'Saigai Seeragu', pageTitle: 'Saigai Seeragu — Present with live captions',
    ...
    hi: {
      brandName: 'Saigai Seeragu', pageTitle: 'Saigai Seeragu — लाइव कैप्शन के साथ प्रस्तुत करें',
